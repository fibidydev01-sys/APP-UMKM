      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        <ScrollStack>
            ...
            <ScrollStackItem>
              <div className="min-h-screen flex items-center justify-center p-8">
                <div className="max-w-5xl w-full">
                  <FadeContent fadeDirection="up" duration={1} delay={0.3}>
                    <div className="relative">
                      <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 mb-8">
          ...
          <ScrollStackItem>
            <div className="min-h-screen flex items-center justify-center p-8">
              <div className="max-w-4xl w-full">
                <AnimatedContent animationType="fade" duration={1} delay={0.4}>
            ...
            {(logo || storeName) && (
              <Magnet padding={50} magnetStrength={40}>
                <div className="inline-flex items-center gap-4 px-6 py-4 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10">
                  ...
                  {storeName && (
                    <span className="text-xl font-black">{storeName}</span>
                  )}
                </div>
              </Magnet>
            )}
...
export function Hero149({
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0 z-0">
        <Spotlight size={800} speed={0.4} particleColor="#ffffff" />
      </div>
          ...
          >
            ...
            >
              <div className="p-12 md:p-20 space-y-12">
                ...
                >
                  <GlassIcons items={glassIcons} colorful />
                </motion.div>
          ...
          <MagicBento>
            ...
            {backgroundImage && (
              <div className="col-span-2 row-span-2">
                <ReflectiveCard borderRadius={30} reflectionOpacity={0.3}>
              ...
              <ReflectiveCard borderRadius={30} reflectionOpacity={0.3}>
                <div className="w-full h-full min-h-[400px] rounded-[30px] bg-white/5 backdrop-blur-xl border border-white/10 p-10 flex flex-col justify-center space-y-4">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    Premium products with unmatched quality and design
                    excellence.
                  </p>
                </div>
              </ReflectiveCard>
