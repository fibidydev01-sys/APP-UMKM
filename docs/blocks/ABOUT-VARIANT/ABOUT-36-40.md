...
experimental layouts, dan creative combinations.
...
<GooeyNav items={navItems} particleCount={15} animationTime={600} />
```
...
<FlowingMenu items={menuItems} speed={15} marqueeBgColor="#3b82f6" />
```
...
<CardNav items={navItems} theme="dark" ease="power3.out" />
```
