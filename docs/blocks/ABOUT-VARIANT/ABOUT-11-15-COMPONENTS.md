...
export function About12({ title, subtitle, content, image, features = [] }: About12Props) {
  return (
    <section id="about" className="relative py-20 overflow-hidden">
...
export function About13({ title, subtitle, content, image, features = [] }: About13Props) {
  return (
    <section id="about" className="relative py-20 overflow-hidden">
      {/* Ballpit Background */}
...
export function About14({ title, subtitle, content, image, features = [] }: About14Props) {
  return (
    <section id="about" className="relative py-20 overflow-hidden">
...
export function About15({ title, subtitle, content, image, features = [] }: About15Props) {
  return (
    <section id="about" className="relative py-20 overflow-hidden">
      {/* Plasma Background */}
