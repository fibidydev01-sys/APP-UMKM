...
5 About section variants dengan React Bits integration, responsive layouts, dan modern design.
...
export function About01({ title, subtitle, content, image, features = [] }: About01Props) {
  return (
...
export function About02({ title, subtitle, content, image, features = [] }: About02Props) {
  return (
    <section id="about" className="relative py-20 overflow-hidden">
...
export function About03({ title, subtitle, content, image, features = [] }: About03Props) {
  return (
    <section id="about" className="relative py-20 overflow-hidden">
      {/* Dot Grid Background */}
...
export function About04({ title, subtitle, content, image, features = [] }: About04Props) {
  const masonryItems = [
...
export function About05({ title, subtitle, content, image, features = [] }: About05Props) {
  const galleryImages = [
    image,
