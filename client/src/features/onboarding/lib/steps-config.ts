...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  // ===== CRITICAL ITEMS (Required to publish) =====
  {
    ...
    description:
      'Logo adalah identitas brand utama. Akan tampil di header dan semua halaman toko Anda.',
    field: 'logo',
    points: 4,
    isCritical: true,
  ...
  // ===== HIGH IMPACT (Recommended) =====
  {
    ...
    description:
      'Upload produk untuk mulai berjualan online. Pelanggan bisa langsung melihat katalog Anda.',
    field: 'products',
    points: 10,
    isCritical: false,
  ...
  },
  {
    ...
    description:
      'Social proof membangun kepercayaan. Tambah minimal 1 testimoni dari pelanggan puas Anda.',
    field: 'testimonials',
    points: 4,
    isCritical: false,
