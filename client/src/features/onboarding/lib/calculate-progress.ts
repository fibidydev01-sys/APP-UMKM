...
import { type OnboardingProgress, type OnboardingStepStatus } from './types';
 ...
 */
export function calculateFullProfileProgress(tenant: Tenant, productsCount: number = 0): number {
  let score = 0;
