...
const ABOUT_VARIANTS: VariantOption[] = [
  ...
  { value: 'image-gallery', label: 'Image Gallery', description: 'Image gallery layout', icon: Gallery },
  { value: 'tab-sections', label: 'Tab Sections', description: 'Tabbed sections', icon: Tabs },
...
const PRODUCTS_VARIANTS: VariantOption[] = [
  ...
  { value: 'product-tabs', label: 'Product Tabs', description: 'Product category tabs', icon: Tabs },
