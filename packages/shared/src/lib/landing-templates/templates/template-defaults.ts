...
export const TEMPLATE_DEFAULTS: Record<TemplateId, Partial<TenantLandingConfig>> = {
  'suspended-minimalist': {
    ...
    about: {
      ...
      config: {
        content:
          'Kami berkomitmen untuk memberikan produk terbaik dengan harga yang terjangkau. Kepuasan pelanggan adalah prioritas utama kami.',
        showImage: false,
      },
    },
    products: {
  ...
  'modern-starter': {
    ...
    hero: {
      ...
      subtitle:
        'Makanan adalah seni, dan makanan adalah cinta. Kami mengantarkan kehangatan dari cita rasa terbaik langsung ke pintu rumah Anda dengan penuh kasih sayang.',
      config: {
        layout: 'centered',
        showCta: true,
    ...
    about: {
      ...
      config: {
        content:
          'Sejak 2020, kami telah melayani ribuan pelanggan dengan produk berkualitas tinggi. Kepercayaan Anda adalah aset terbesar kami.',
        showImage: true,
      },
    },
    products: {
  ...
  'bold-starter': {
    ...
    about: {
      ...
      config: {
        content:
          'Produk original, harga bersaing, pengiriman cepat, dan customer service terbaik. Ribuan pelanggan telah mempercayai kami!',
        showImage: true,
        features: [
          {
  ...
  'classic-starter': {
    ...
    about: {
      ...
      config: {
        content:
          'Berawal dari usaha kecil, kini kami telah berkembang menjadi salah satu toko terpercaya dengan ribuan pelanggan setia.',
        showImage: true,
      },
    },
    products: {
  ...
  'brand-starter': {
    ...
    about: {
      ...
      config: {
        content:
          'Setiap produk yang kami tawarkan memiliki cerita. Dari pemilihan bahan baku terbaik hingga proses yang penuh dedikasi, semua kami lakukan untuk Anda.',
        showImage: true,
      },
    },
    products: {
  ...
  'elegant-starter': {
    ...
    about: {
      ...
      config: {
        content:
          'Every detail matters. From the finest materials to impeccable craftsmanship, we deliver excellence.',
        showImage: true,
      },
    },
    products: {
  ...
  'dynamic-starter': {
    ...
    about: {
      ...
      config: {
        content:
          'We are not just another store. We are your partner in success, bringing you cutting-edge products and exceptional service.',
        showImage: true,
        features: [
          {
  ...
  'professional-starter': {
    ...
    about: {
      ...
      config: {
        content:
          'With over a decade of experience, we provide professional-grade solutions that businesses rely on. Our commitment to excellence is unmatched.',
        showImage: true,
      },
    },
    products: {
...
export function mergeWithTemplateDefaults(
  ...
  return {
    ...
    products: existingConfig.products
      ? { ...defaults.products, ...existingConfig.products }
      : defaults.products,
    testimonials: existingConfig.testimonials
      ? { ...defaults.testimonials, ...existingConfig.testimonials }
      : defaults.testimonials,
    contact: existingConfig.contact
      ? { ...defaults.contact, ...existingConfig.contact }
      : defaults.contact,
