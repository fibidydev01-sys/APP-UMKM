...
import { cn } from '@umkm/shared/utils';
            ...
            <div className="flex items-center gap-3 min-w-0 pr-10">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  <span style={{ color: primaryColor }}>{categoryInfo.labelShort}</span>
                  {tenant.address && (
                    <>
                      <span>·</span>
            ...
            <div className="px-4 pb-8 max-w-2xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6 text-sm">
                <div className="flex items-center gap-1.5 text-muted-foreground">
                  ...
                  <span>
                    <strong className="text-foreground">{productCount}</strong> produk
                  </span>
                </div>
                <Badge
                  variant="secondary"
              ...
              {tenant.description && (
                <div className="mb-6">
                  <p className="text-muted-foreground leading-relaxed">{tenant.description}</p>
                </div>
              )}
              ...
              >
                <span className="text-sm text-muted-foreground truncate">{tenantUrl}</span>
                {copied ? (
              ...
              <div className="flex gap-3">
                <Button variant="outline" className="flex-1 h-11 gap-2" onClick={handleShare}>
