...
import { CATEGORY_CONFIG, CATEGORY_GROUPS, getCategoriesByGroup } from '@umkm/shared/config';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Temukan berbagai usaha lokal Indonesia. Warung, salon, bengkel, dan ribuan UMKM
              lainnya.
            </p>
            ...
            <div className="mb-6 relative z-30">
              <DropdownMenu modal={false}>
                ...
                <DropdownMenuContent
                  align="start"
                  className="rounded-xl border-2 shadow-xl min-w-[180px]"
                >
                  {tabs.map((tab) => (
                    <DropdownMenuItem
                      key={tab.id}
