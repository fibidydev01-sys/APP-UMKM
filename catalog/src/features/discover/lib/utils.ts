...
import { getInitials } from '@umkm/shared'; // Use from format.ts
 ...
 */
export function sortTenants(tenants: ShowcaseTenant[], sortBy: SortOption): ShowcaseTenant[] {
 ...
 */
export function filterTenantsBySearch(tenants: ShowcaseTenant[], query: string): ShowcaseTenant[] {
